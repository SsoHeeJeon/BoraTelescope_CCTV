...
public class CaptureMode : ScreenCapture
{
    ...
    */
    ...
    public void SetMark()
    {
        ...
        {
            customMark.transform.parent = gamemanager.clearmode.CameraWindow.transform.GetChild(1).gameObject.transform;
            customMark.transform.localPosition = Vector3.zero;
