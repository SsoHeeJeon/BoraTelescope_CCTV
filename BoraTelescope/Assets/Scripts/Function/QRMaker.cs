...
public class QRMaker : MonoBehaviour
{
    ...
    */
    public void waitQRcode() {
        ...
        if (SceneManager.GetActiveScene().name == "XRMode")
        {
                FunctionCustom.functionorigin.capturemode.customMark.transform.parent = FunctionCustom.functionorigin.capturemode.flasheffect.transform.parent.gameObject.transform;
        } else if (SceneManager.GetActiveScene().name.Contains("ClearMode"))
        {
                FunctionCustom.functionorigin.capturemode.customMark.transform.parent = FunctionCustom.functionorigin.capturemode.flasheffect.transform.parent.gameObject.transform;
        }

            FunctionCustom.functionorigin.capturemode.customMark.transform.localPosition = CaptureMode.originPos;

            FunctionCustom.functionorigin.capturemode.customMark.gameObject.SetActive(false);
