...
public class GoldSunsuetLabel : MonoBehaviour
{
    ...
    {
        Label_total = new List<string> { "UIsland", "Ganghwa", "JoR", "Ssangma", "SongakM",
                                         "HanteoM", "Gijungdong", "Daesungdong", "SeoglyupoV", "ImjinR",
                                         "Odusan"};
