...
public class MinimalPlayback : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        //Thread videoThread = new Thread(SeeCCTV);
        //videoThread.Start();
        SeeCCTV();
    }
    ...
    public void PlayPause()
    {
        ...
        else
        {
            ...
            if (_mediaPlayer.Media == null)
            {
                ...
                _mediaPlayer.Media = new Media(_libVLC, new Uri("rtsp://admin:Bora7178@"+SunAPITest.CCTVControl.url+"/00/profile2/media.smp"));    // url 변경 필요
